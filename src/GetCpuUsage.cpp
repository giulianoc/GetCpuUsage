...
static struct nlist nlst[] = {{"_cp_time", 0}, {"_cnt", 0}, {"_bufspace", 0}, {0, 0}};
...

{
	...
	if (host_processor_info(mach_host_self(), PROCESSOR_CPU_LOAD_INFO, &n_cpus, (processor_info_array_t *)&pinfo, &info_count))
	{
		return 0;
	}
